...
export const getAuditLogs = async (params) => {
  ...
  const dummyLogs = [
    { id: 1, timestamp: '2025-04-01T18:30:00Z', user: 'admin@example.com', action: 'Patient Created', details: 'Patient ID: 123, Name: John Doe' },
    { id: 2, timestamp: '2025-04-01T18:35:10Z', user: 'admin@example.com', action: 'Order Status Updated', details: 'Order ID: 456, Status: Shipped' },
    { id: 3, timestamp: '2025-04-01T18:40:25Z', user: 'support@example.com', action: 'User Logged In', details: 'User ID: 789' },
...
export const createAuditLog = async (logData) => {
    ...
    return { success: true, log: { id: Date.now(), ...logData, user: 'current_user@example.com', timestamp: new Date().toISOString() } };
};
