...
export const useTags = (params = {}) => {
  return useQuery({
    ...
    queryFn: async () => {
      let query = supabase
        .from('tags') // Use 'tags' table name (created in 20240322000003)
        .select('*')
  ...
  return useMutation({
    mutationFn: async (tagData) => {
      ...
      const dataToInsert = {
        ...
        // ID should be generated by the database (assuming it's a UUID type)
        // Remove the client-side ID generation/assignment
