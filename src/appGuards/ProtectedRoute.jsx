 ...
 * Also supports requiredRole parameter to restrict access based on user role.
 */
const ProtectedRoute = ({ children, requiredRole }) => {
  ...
  // If role is required and user doesn't have it, but super user mode is enabled, allow access
  if (requiredRole && userRole !== requiredRole && !isSuperUser) {
