...
const betterSexPrograms = [
  {
    id: 1,
    category: 'Sex Tips',
    title: 'Boosting Arousal',
    description: '7 tips to get in the mood',
    videoLength: '1 min',
    imageUrl: 'https://via.placeholder.com/300x200',
    providerAvatarUrl: 'https://via.placeholder.com/50x50',
    status: null, // null, 'Done', 'In Progress'
  },
  {
    id: 2,
    category: 'Sex Ed',
    title: 'ED Pills For Men',
    description: 'A urologist explains',
    videoLength: '1 min',
    imageUrl: 'https://via.placeholder.com/300x200',
    providerAvatarUrl: 'https://via.placeholder.com/50x50',
    status: 'Done',
  },
  {
    ...
    description: 'Improve intimacy with your partner',
    videoLength: '3 min',
    imageUrl: 'https://via.placeholder.com/300x200',
    providerAvatarUrl: 'https://via.placeholder.com/50x50',
    status: null,
...
const BetterSexSection = ({ handleProgramClick, handleWatchVideo }) => {
  return (
...
export default BetterSexSection;
