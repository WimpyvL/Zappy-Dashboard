...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.password) newErrors.password = "Password is required";
      ...
      if (failedRequirements.length > 0) newErrors.password = "Password does not meet all requirements";
    }
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <input id="firstName" name="firstName" type="text" autoComplete="given-name" required
                  ...
                  placeholder="John" value={formData.firstName} onChange={handleInputChange} />
              ...
              <div>
                ...
                <input id="lastName" name="lastName" type="text" autoComplete="family-name" required
                  ...
                  placeholder="Doe" value={formData.lastName} onChange={handleInputChange} />
            ...
            <div className="mb-6">
              ...
              <input id="email" name="email" type="email" autoComplete="email" required
                ...
                placeholder="your.email@example.com" value={formData.email} onChange={handleInputChange} />
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <button type="button" className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-500" onClick={togglePasswordVisibility}>
              ...
              <div className="mt-2 space-y-2">
                {passwordRequirements.map((req) => (
                  <div key={req.id} className="flex items-center text-sm">
                    {req.test(formData.password) ? <Check className="h-4 w-4 text-green-500 mr-2" /> : <X className="h-4 w-4 text-gray-300 mr-2" />}
                    <span className={req.test(formData.password) ? "text-green-700" : "text-gray-500"}>{req.label}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <select id="role" name="role" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value={formData.role} onChange={handleInputChange}>
            ...
            <div className="mb-6">
              ...
              <input id="referralCode" name="referralCode" type="text" autoComplete="off"
                className={`appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                placeholder="Enter code if you have one" value={formData.referralCode} onChange={handleInputChange} />
            </div>
            {/* Terms */}
            <div className="mb-6">
