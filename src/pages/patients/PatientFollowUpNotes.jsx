  ...
  useEffect(() => {
    if (existingNote?.data) {
      ...
      setFormData({
        ...
        currentWeight:
          existingNote.data.currentWeight || patient?.currentWeight || 0,
        // Use the weight from the note as previous if available, else patient's previous
        previousWeight:
          existingNote.data.previousWeight || patient?.previousWeight || 0,
        treatmentPlan: {
          medicationPlan:
            existingNote.data.treatmentPlan?.medicationPlan || 'continue',
          lifestyleRecommendations:
            existingNote.data.treatmentPlan?.lifestyleRecommendations ||
            'continue',
          providerComments:
            existingNote.data.treatmentPlan?.providerComments || '',
          followUpInterval:
            existingNote.data.treatmentPlan?.followUpInterval || '4_weeks',
        },
      });
    } else if (patient) {
              ...
              <div>
                ...
                {editable.weight ? (
                  ...
                  <div className="text-lg font-medium">
                    ...
                    {weightChange.change !== 0 && (
                      <span
                        className={`ml-2 text-sm ${weightChange.change < 0 ? 'text-green-600 bg-green-50' : 'text-red-600 bg-red-50'} px-2 py-0.5 rounded-full`}
                      >
                        {weightChange.change < 0 ? (
            ...
            {editable.treatmentPlan ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="increase_exercise">
                      Increase exercise frequency/intensity
                    </option>
                    <option value="diet_changes">
                      Modify dietary approach
                    </option>
                    <option value="food_journal">Start food journal</option>
                    <option value="nutrition_referral">
              ...
              <div className="space-y-3">
                    ...
                    <div className="mt-1">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                        ...
                        {planOptions.find(
                          (option) =>
                            option.value ===
                            formData.treatmentPlan.medicationPlan
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                        {formData.treatmentPlan.lifestyleRecommendations ===
                        'continue'
                          ...
                          : formData.treatmentPlan.lifestyleRecommendations ===
                            ...
                            : formData.treatmentPlan
                                  .lifestyleRecommendations === 'diet_changes'
                              ? 'Modify diet'
                              : formData.treatmentPlan
                                    .lifestyleRecommendations === 'food_journal'
                                ? 'Start food journal'
                                : formData.treatmentPlan
                                      .lifestyleRecommendations ===
                                    'nutrition_referral'
                ...
                <div>
                  ...
                  <div className="mt-1 text-sm text-gray-700 p-3 bg-gray-50 rounded-md whitespace-pre-line">
                    {formData.treatmentPlan.providerComments ||
                      'No provider comments recorded.'}
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <span className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                        ...
                        {formData.treatmentPlan.followUpInterval.replace(
                          '_',
                          ' '
                        )}
                      </span>
