  ...
  return (
    <div className="bg-gray-50 pb-20">
      ...
      <div id="active-state" className="space-y-8">
        ...
        <div className="mt-16 bg-white rounded-xl shadow-md overflow-hidden border-2 border-[#F85C5C]/20">
        ...
        <div className="mt-16 bg-white rounded-xl shadow-md overflow-hidden border-2 border-[#4F46E5]/20">
          <div className="px-5 py-4 border-b border-gray-100">
...
export default PatientServicesPageV2;
