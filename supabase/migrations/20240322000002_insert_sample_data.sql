...
INSERT INTO client_record (first_name, last_name, email, phone, date_of_birth, address, city, state, zip, created_at)
VALUES
  ('John', 'Doe', 'john.doe@example.com', '555-123-4567', '1980-01-15', '123 Main St', 'Anytown', 'CA', '90210', NOW()),
  ('Jane', 'Smith', 'jane.smith@example.com', '555-987-6543', '1992-05-22', '456 Oak Ave', 'Somewhere', 'NY', '10001', NOW()),
  ('Michael', 'Johnson', 'michael.j@example.com', '555-555-5555', '1975-11-30', '789 Pine Rd', 'Elsewhere', 'TX', '75001', NOW())
ON CONFLICT (email) DO NOTHING;

-- Insert sample products
INSERT INTO products (name, description, price, category, sku, inventory_count) -- Corrected column name
VALUES
