...
-- 3. Allow authenticated users to read specific columns of other profiles (optional, adjust as needed)
-- Example: Allow reading first_name, last_name, role of any profile
-- CREATE POLICY "Allow authenticated read access to basic profile info"
